...
uint32_T _gyro_calibration_algorithm_atomic_sub_chart_libraryMachineNumber_;

/* Function Declarations */

/* Function Definitions */
void gyro_calibration_algorithm_atomic_sub_chart_library_initializer(void)
{
}

void gyro_calibration_algorithm_atomic_sub_chart_library_terminator(void)
{
}
  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,
                  "gyro_calibration_algorithm_atomic_sub_chart_library")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(379297353U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1906761668U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3438980677U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1171477630U);
        } else if (nrhs==4) {
  ...
  ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 2:
      {
        if (strcmp(aiChksum, "82X6xD5NvJhfslkp2DkzGG") == 0) {
          extern mxArray
  ...
  ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 2:
      {
        if (strcmp(tpChksum, "FC7IeRrUWBxVRTDVJi2xfE") == 0) {
          extern mxArray
...
unsigned int
  sf_gyro_calibration_algorithm_atomic_sub_chart_library_jit_fallback_info( int
...
void gyro_calibration_algorithm_atomic_sub_chart_library_debug_initialize(struct
  SfDebugInstanceStruct* debugInstance)
{
  _gyro_calibration_algorithm_atomic_sub_chart_libraryMachineNumber_ =
    ...
    "gyro_calibration_algorithm_atomic_sub_chart_library","sfun",1,1,0,0,0);
  sf_debug_set_machine_event_thresholds(debugInstance,
    _gyro_calibration_algorithm_atomic_sub_chart_libraryMachineNumber_,0,0);
  sf_debug_set_machine_data_thresholds(debugInstance,
    _gyro_calibration_algorithm_atomic_sub_chart_libraryMachineNumber_,0);
}
  ...
  (void)
{
  if (sRtwOptimizationInfoStruct==NULL) {
    sRtwOptimizationInfoStruct = sf_load_rtw_optimization_info(
      "gyro_calibration_algorithm_atomic_sub_chart_library", "et_robocon");
