function [speed] = control_sphero_motion(dist, groundspeed, Kp, Ki, Kd, stopRadius, maxspeed, minspeed, restartspeed, clearvars)
%CONTROL_SPHERO_MOTION PID Controller for Sphero motion
% CONTROL_SPHERO_MOTION(DIST, GROUNDSPEED, KP, KI, KD, STOPRADIUS, MAXSPEED, MINSPEED, RESTARTSPEED, CLEARVARS)
% Input Arguments:
