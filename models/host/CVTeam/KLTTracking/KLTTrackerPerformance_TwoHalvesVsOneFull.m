%% Tracking a bot using the Kanade-Lucas-Tomasi algorithm
% Checking performance of using two trackers of 10 points each versus one
% tracker of 20 points.
% This is to see how much overload each additional tracker object has
% versus the overload of additional points.
...
points = points.selectStrongest(40);
