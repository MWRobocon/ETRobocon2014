...
info.Constants.RspGetOptionsFlag = uint8(hex2dec('05'));
info.Constants.RspGetTempOptionsFlag = uint8(hex2dec('05'));
info.Constants.RspGetDeviceMode = uint8(hex2dec('02'));
info.Constants.RspSsbRefill = uint8(hex2dec('05'));
info.Constants.RspSsbBuy= uint8(hex2dec('06'));
info.Constants.RspSsbUseConsumeable = uint8(hex2dec('03'));
info.Constants.RspSsbGrantCores = uint8(hex2dec('05'));
info.Constants.RspSsbAddXp = uint8(hex2dec('05'));
info.Constants.RspSsbLevelUpAttr = uint8(hex2dec('05'));
info.Constants.RspGetPwSeed = uint8(hex2dec('05'));
info.Constants.RspAbortMacro = uint8(hex2dec('04'));
info.Constants.RspMacroStatus = uint8(hex2dec('04'));
