...
#ifndef RTW_HEADER_phiController_private_h_
#define RTW_HEADER_phiController_private_h_
...
#endif                                 /* RTW_HEADER_phiController_private_h_ */
