...
#define S_FUNCTION_NAME  sfcn_digitalwriteA07
...
//	ssSetSFcnParamTunable(S, 0, 1);
    ...
    ssSetInputPortDataType(S, 3, DYNAMICALLY_TYPED);
    ssSetInputPortDataType(S, 4, DYNAMICALLY_TYPED);
    ssSetInputPortDataType(S, 5, DYNAMICALLY_TYPED);
    ssSetInputPortDataType(S, 6, DYNAMICALLY_TYPED);
