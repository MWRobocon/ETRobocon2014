function [tracks, nextId] = createNewTracks(tracks, unassignedDetections, centroids, bboxes, nextId, locations)
        ...
        for i = 1:size(centroids, 1)
            ...
            % Match tracks with feature detected objects
            ...
            % Undistorted centroid
            undistortedCentroid = undistortPoints(centroid,cameraParams);
            ...
            newTrack = struct(...
                ...
                'bbox', bbox, ...
                'centroid', centroid, ...
                'undistortedCentroid', undistortedCentroid, ...
