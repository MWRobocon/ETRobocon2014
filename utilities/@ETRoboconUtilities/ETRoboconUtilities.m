classdef ( ...
    ...
    properties ( ...
        ...
        DOCUMENTATION_ROOT = ...
            fullfile( ETRoboconUtilities.getCheckoutRoot( ), 'documents' );
        ...
        PATH_ROOTS_TO_ADD_RECURSIVELY_CELLSTR = ...
            ...
            fullfile( ETRoboconUtilities.getCheckoutRoot( ), 'templates' ); ...
            ...
            if( true == ispc() )
                ...
                if( true == isempty( installedPackages ) )
                    ...
                    if( true == legoMindstormsPackageIsInstalled )
                        ...
                        warning( 'The LEGO Mindstorms "Run On Target Hardware" packages are not installed. Please open Simulink and install them by selecting "Tools"->"Run on Target Hardware"->"Install/Update support package".' );
                    end
